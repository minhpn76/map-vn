      ...
      <div className="container sign--up" style={{ height: '100vh' }}>
        <Grid container justify="center">
          ...
          >
            ...
            <DialogContent>
              <DialogContentText>
                <FormattedMessage id="signInPage.OpsSystems"/>
            ...
            {props => (
              <form onSubmit={props.handleSubmit}>
                ...
                <Grid item xs={12} className="action--forgot">
                  <Link to="/"><FormattedMessage id="signInPage.forgotPassword"/></Link>
                </Grid>
          ...
          <Grid item xs={12} className="action--signup">
            <Container className="description"><FormattedMessage id="signInPage.btnSignInOther"/></Container>
            <SocialNetwork
      ...
      >
        <Grid item xs={12}>
          <Typography align="center" className="text--have--account">
            <FormattedMessage id="signInPage.haveAccount"/>
