...
function SignUpPage(props: Props) {
  ...
  const validationSchema = () => {
    return Yup.object().shape({
      name: Yup.string()
        .trim()
        .min(7, <FormattedMessage id="signUpPage.validate.fullNameMin" />)
        .required(() => <FormattedMessage id="signUpPage.validate.fullNameRequired" />),
      email: Yup.string()
        .trim()
        .email(() => <FormattedMessage id="signUpPage.validate.emailIsValid" />)
        .required(() => <FormattedMessage id="signUpPage.validate.emailRequired" />),
      country: Yup.string()
        .trim()
        .required(() => <FormattedMessage id="signUpPage.validate.countryRequired" />),
      password: Yup.string()
        .trim()
        .min(8, <FormattedMessage id="signUpPage.validate.passMin" />)
        .required(() => <FormattedMessage id="signUpPage.validate.passRequired" />),
      password_confirmation: Yup.string()
        .trim()
        .oneOf([Yup.ref('password'), null], <FormattedMessage id="signUpPage.validate.passConfirmIsMatch" />)
        .required(() => <FormattedMessage id="signUpPage.validate.passConfirmRequired" />),
    });
  };
      ...
      <div className="container sign--up">
        <Grid container justify="center">
          ...
          >
            ...
            <DialogContent>
              <DialogContentText>
                <FormattedMessage id="signUpPage.OpsSystems"/>
                ...
                <Grid item xs={12} className="input--signup">
                  <FormControl className="form--control">
                    <InputLabel shrink htmlFor="bootstrap-input">
                      <FormattedMessage id="signUpPage.fullname" />
                    </InputLabel>
                    <CssTextField
                      style={
                  ...
                  <FormControl className="form--control">
                    <InputLabel shrink htmlFor="bootstrap-input">
                      <FormattedMessage id="signUpPage.email" />
                    </InputLabel>
                    <CssTextField
                      className={classes.root}
                      fullWidth
                  ...
                  <FormControl className="form--control">
                    <InputLabel shrink><FormattedMessage id="signUpPage.country" /></InputLabel>
                  ...
                  <FormControl className="form--control">
                    <InputLabel shrink htmlFor="bootstrap-input">
                      <FormattedMessage id="signUpPage.confirmPassword" />
                    </InputLabel>
                    <CssTextField
                      className={classes.root}
                      onChange={props.handleChange}
          ...
          <Grid item xs={12} className="action--signup">
            <Container className="description"><FormattedMessage id="signUpPage.btnSignUpOther" /></Container>
            <SocialNetwork
      ...
      >
        <Grid item xs={12}>
          <Typography align="center" className="text--have--account">
            <FormattedMessage id="signUpPage.alreadyAccount" />
...
export default memo(injectIntl(SignUpPage));
